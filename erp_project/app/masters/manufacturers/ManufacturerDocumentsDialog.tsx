...
export function ManufacturerDocumentsDialog({
  ...
  async function handleSave() {
    ...
    try {
      ...
      for (const tab of DOC_TABS) {
        ...
        form.append("folder", `manufacturers/${mfg.mfg_id}`)
      ...
      const res = await fetch("/api/masters/manufacturers", {
        ...
        body: JSON.stringify({ action: "update_docs", mfg_id: mfg.mfg_id, ...finalDocs }),
      })
  ...
  return (
    <Dialog open={!!mfg} onOpenChange={(o) => !loading && !o && onClose()}>
